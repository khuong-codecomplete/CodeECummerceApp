#pragma checksum "E:\INTERNdotnet\DemoECummerApp\ClientWebApi\Views\Home\Product.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "33525c2b286f5d80a7bc5fc5036a7b1d57e2c52f"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"33525c2b286f5d80a7bc5fc5036a7b1d57e2c52f", @"/Views/Home/Product.cshtml")]
    ...
    public class Views_Home_Product : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            WriteLiteral("<html>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "33525c2b286f5d80a7bc5fc5036a7b1d57e2c52f3199", async() => {
                WriteLiteral(@"
    <meta charset=""utf-8"" />
    ...
    var
       ...
       ");
                WriteLiteral(@"             $('#tblProducts').empty();
                    LoadProducts();
                }
            });
        ...
        function PostOrders() {
   ");
                WriteLiteral(@"         // 1. Build order object to match the model class Orders.cs.
            var order = {
       ...
       ");
        ...
        function AddToCart(productId, productName, qty, price) {
            ...
            var cartItem");
                WriteLiteral(@" = $('#tblCart').find('tr[data-product-id=' + productId + ']');
                ...
                .append($('<tr>')
                    ...
                    .append($('<td>')
                        .append($('<a>')
                            .attr('href', '#')
                            .append($('<");
                WriteLiteral(@"span>').addClass('glyphicon glyphicon-trash'))
                            .click(function () {
        ...
        function PutCart(cartItem) {
            var cart = {
                ...
                Finalprice: cartItem.find('td.price').html().re");
                WriteLiteral(@"place('$', '')
            };
        ...
        function DeleteCart(cartId) {
            $.ajax({
                ...
                success: function (result) {
                    if (result.id) {
                        var cartItem = ");
                WriteLiteral(@"$('#tblCart').find('tr[data-cart-id=' + cartId + ']');
                        cartItem.remove();
                    }
                },
                error: function (message) {
...
");
            ...
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "33525c2b286f5d80a7bc5fc5036a7b1d57e2c52f16196", async() => {
                WriteLiteral(@"
                ...
                WriteLiteral(@"                    <input type=""text"" class=""form-control""
                        ...
                        <div class=""form-group"">
                            ...
                            <div class=""col-sm-10"">
                                <input type=""text"" class=""form-control""
                                       id=""txtPo");
                WriteLiteral(@"stalCode"" placeholder=""Postal Code"" />
                            </div>
                        </div>
                        <div class=""form-group"">
                            <label class=""col-sm-2 control-label""
